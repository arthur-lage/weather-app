...
form.addEventListener("submit", (e) => {
    ...
    getData(city)
                     ...
                     //http://api.openweathermap.org/data/2.5/weather?q=London&appid=99f9d1e992ebf7091f2f24e748535ae1
...
function showWeather(data){
    ...
    temperatureText.innerHTML = `${kelvinToCelsius(data.main.temp).toFixed(2)} ºC`
